...
//Guarda inicial
?><img src="http://localhost/phpstore/res/boletophp/imagens/p.png" width=<?php echo $fino?> height=<?php echo $altura?> border=0>
<img src="http://localhost/phpstore/res/boletophp/imagens/b.png" width="<?php echo $fino?>" height="<?php echo $altura?>" border=0>
<img src="http://localhost/phpstore/res/boletophp/imagens/p.png" width=<?php echo $fino?> height=<?php echo $altura?> border=0>
<img src="http://localhost/phpstore/res/boletophp/imagens/b.png" width=<?php echo $fino?> height=<?php echo $altura?> border=0>
<img 
<?php
...
?>
    src="http://localhost/phpstore/res/boletophp/imagens/p.png" width=<?php echo $f1?> height=<?php echo $altura?> border=0><img 
<?php
    if (substr($f,$i,1) == "0") {
      $f2 = $fino ;
    }else{
...
?>
    src="http://localhost/phpstore/res/boletophp/imagens/b.png" width=<?php echo $f2?> height=<?php echo $altura?> border=0><img 
<?php
  }
}
...
// Draw guarda final
?>
src="http://localhost/phpstore/res/boletophp/imagens/p.png" width=<?php echo $largo?> height=<?php echo $altura?> border=0><img 
src="http://localhost/phpstore/res/boletophp/imagens/b.png" width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
src="http://localhost/phpstore/res/boletophp/imagens/p.png" width=<?php echo 1?> height=<?php echo $altura?> border=0> 
  <?php
} //Fim da fun��o
