<?php
    ...
    class User extends Model
    {
        ...
        public static function getPage($page = 1, $itemsPerPage = 10)
        {
            ...
            $results = $sql->select(
                "SELECT SQL_CALC_FOUND_ROWS * FROM tb_users a INNER JOIN tb_persons b USING(idperson) ORDER BY a.iduser DESC
        ...
        public static function getPageSearch($search, $page, $itemsPerPage = 10)
        {
            ...
            $results = $sql->select(
                "SELECT SQL_CALC_FOUND_ROWS * FROM tb_users a INNER JOIN tb_persons b USING(idperson) WHERE b.desperson LIKE :search_like OR b.desemail = :search OR a.deslogin LIKE :search_like ORDER BY a.iduser DESC
